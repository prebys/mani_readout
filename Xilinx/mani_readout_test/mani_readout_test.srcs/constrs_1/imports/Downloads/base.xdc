...
#!!! -EjP  Redefine PMODA0-PMODA4 to match our use for the LTC2324 ADC module
...
## Pmodb
#!!! -EjP  Redefine PMODAB-PMODB4 to match our use for the LTC2324 ADC module
#set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {pmodb_gpio_tri_io[1]}]
#!!! -EjP Redefine PMODB[1]
