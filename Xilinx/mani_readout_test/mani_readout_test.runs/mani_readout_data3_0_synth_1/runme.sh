...
HD_PWD='G:/My Drive/github/mani_readout/Xilinx/mani_readout_test/mani_readout_test.runs/mani_readout_data3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mani_readout_data3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mani_readout_data3_0.tcl
