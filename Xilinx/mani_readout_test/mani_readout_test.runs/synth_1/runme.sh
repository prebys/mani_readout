...
HD_PWD='G:/My Drive/github/mani_readout/Xilinx/mani_readout_test/mani_readout_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mani_readout_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mani_readout_wrapper.tcl
