...
HD_PWD='G:/My Drive/github/mani_readout/Xilinx/mani_readout_test/mani_readout_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mani_readout_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mani_readout_wrapper.tcl -notrace
